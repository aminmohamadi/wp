<?php
namespace SiliconElementor\Modules\Posts\Traits;
...
trait Button_Widget_Trait {
	...
	public static function get_button_sizes() {
		return [
			'xs' => esc_html__( 'Extra Small', 'silicon-elementor' ),
			'sm' => esc_html__( 'Small', 'silicon-elementor' ),
			'md' => esc_html__( 'Medium', 'silicon-elementor' ),
	...
	protected function register_button_content_controls( $args = [] ) {
		$default_args = [
			'section_condition'      => [],
			'button_text'            => esc_html__( 'Click here', 'silicon-elementor' ),
			'control_label_name'     => esc_html__( 'Text', 'silicon-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default'      => '',
				'options'      => [
					'primary' => esc_html__( 'Default', 'silicon-elementor' ),
		...
		$this->add_control(
			'icon_align',
			[
				'label'     => esc_html__( 'Icon Position', 'silicon-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'left',
				'options'   => [
					'right'  => esc_html__( 'Before', 'silicon-elementor' ),
					'left' => esc_html__( 'After', 'silicon-elementor' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .btn__load-more .elementor-align-icon-left' => 'margin-left: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .btn__load-more .elementor-align-icon-right' => 'margin-right: {{SIZE}}{{UNIT}}; order: 11;',
				],
				'condition' => $args['section_condition'],
			]
		);
		...
		$this->add_control(
			'view',
			[
				'label'     => esc_html__( 'View', 'silicon-elementor' ),
		...
		$this->add_control(
			'button_wrapper_css',
			[
				'label'       => esc_html__( 'Button Wrapper CSS', 'silicon-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'description' => esc_html__( 'Additional CSS to be applied to .btn-wrapper element.', 'silicon-elementor' ),
				'condition'   => $args['section_condition'],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__( 'Additional CSS to be applied to .btn element.', 'silicon-elementor' ),
				'condition'   => $args['section_condition'],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => '',
				'title'       => esc_html__( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'silicon-elementor' ),
