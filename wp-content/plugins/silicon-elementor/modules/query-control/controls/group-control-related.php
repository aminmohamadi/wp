...
class Group_Control_Related extends Group_Control_Query {
	...
	protected function init_fields_by_name( $name ) {
		...
		$fields['post_type']['options']['related']                = __( 'Related', 'silicon-elementor' );
		...
		$related_taxonomies = [
			'label'        => __( 'Term', 'silicon-elementor' ),
		...
		$related_fallback = [
			'label'       => __( 'Fallback', 'silicon-elementor' ),
			'type'        => Controls_Manager::SELECT,
			'options'     => [
				'fallback_none'   => __( 'None', 'silicon-elementor' ),
				'fallback_by_id'  => __( 'Manual Selection', 'silicon-elementor' ),
				'fallback_recent' => __( 'Recent Posts', 'silicon-elementor' ),
			],
			'default'     => 'fallback_none',
			'description' => __( 'Displayed if no relevant results are found. Manual selection display order is random', 'silicon-elementor' ),
			'condition'   => [
				'post_type' => 'related',
			],
			'separator'   => 'before',
