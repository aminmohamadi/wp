<?php
namespace SiliconElementor\Modules\CustomAttributes;
...
class Module extends Module_Base {
    ...
    private function get_black_list_attributes() {
        ...
        if ( null === $black_list ) {
             ...
             */
            $black_list = apply_filters( 'silicon_elementor/element/attributes/black_list', $black_list );
        }
    ...
    public function register_custom_attributes_controls( Element_Base $element ) {
        ...
        $element->start_controls_section(
            '_section_attributes',
            [
                'label' => __( 'Attributes', 'silicon-elementor' ),
        ...
        $element->add_control(
            '_attributes',
            [
                'label' => __( 'Custom Attributes', 'silicon-elementor' ),
                'type' => Controls_Manager::TEXTAREA,
                'dynamic' => [
                    'active' => true,
                ],
                'placeholder' => __( 'key|value', 'silicon-elementor' ),
                'description' => sprintf( __( 'Set custom attributes for the wrapper element. Each attribute in a separate line. Separate attribute key from the value using %s character.', 'silicon-elementor' ), '<code>|</code>' ),
