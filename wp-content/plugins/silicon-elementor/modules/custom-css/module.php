<?php
namespace SiliconElementor\Modules\CustomCss;
...
class Module extends Module_Base {
    ...
    public function replace_go_pro_custom_css_controls( $controls_stack ) {
        ...
        $controls_stack->start_controls_section(
            'section_custom_css',
            [
                'label' => esc_html__( 'Custom CSS', 'silicon-elementor' ),
                'tab' => $old_section['tab'],
            ]
        );
        ...
        $controls_stack->add_control(
            'custom_css_title',
            [
                'raw' => esc_html__( 'Add your own custom CSS here', 'silicon-elementor' ),
        ...
        $controls_stack->add_control(
            ...
            [
                'raw' => esc_html__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'silicon-elementor' ),
                'type' => Controls_Manager::RAW_HTML,
    ...
    public function localize_settings( array $settings ) {
        $settings['i18n']['custom_css'] = esc_html__( 'Custom CSS', 'silicon-elementor' );
