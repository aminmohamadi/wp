...
namespace SiliconElementor\Templates;
...
if ( ! class_exists( 'Premium_Templates' ) ) {
	...
	class Premium_Templates {
		...
		private function load_files() {
			...
			require SILICON_ELEMENTOR_TEMPLATES_PATH . 'classes/config.php';

			require SILICON_ELEMENTOR_TEMPLATES_PATH . 'classes/assets.php';

			require SILICON_ELEMENTOR_TEMPLATES_PATH . 'classes/manager.php';

			require SILICON_ELEMENTOR_TEMPLATES_PATH . 'types/manager.php';

			require SILICON_ELEMENTOR_TEMPLATES_PATH . 'classes/api.php';
