...
namespace SiliconElementor\Templates\Classes;

use SiliconElementor\Templates;
...
if ( ! class_exists( 'Premium_Templates_Manager' ) ) {
	...
	class Premium_Templates_Manager {
		...
		public function __construct() {
			...
			add_filter( 'silicon_elementor_templates_editor_localize', array( $this, 'localize_tabs' ) );
		...
		public function register_sources() {
			...
			require SILICON_ELEMENTOR_TEMPLATES_PATH . 'sources/base.php';
			...
			foreach ( $sources as $key => $class ) {
				...
				require SILICON_ELEMENTOR_TEMPLATES_PATH . 'sources/' . $key . '.php';
		...
		public function get_templates() {
			...
			$all_cats = array(
				array(
					'slug'  => '',
					'title' => __( 'All', 'silicon-elementor' ),
				),
			);
