...
namespace SiliconElementor\Templates\Sources;
...
abstract class Premium_Templates_Source_Base {
	...
	public function templates_key() {
		return 'si_premium_templates_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function categories_key() {
		return 'si_premium_categories_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function keywords_key() {
		return 'si_premium_keywords_' . $this->get_slug() . '_' . $this->get_version();
	}
