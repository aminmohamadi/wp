        ...
        <div>
            ...
            <div class="dup-form-item" id="dup-name-filter-label">
                ...
                <span class="input">
                    ...
                    <label for="filter-names"><?php DUP_PRO_U::esc_html_e("Automatically filter files with invalid encoded names") ?></label>
                    <i class="fas fa-question-circle fa-sm"
            ...
            <div id="dup-exportdb-items-checked">
                <?php
                    ...
                    DUP_PRO_U::esc_html_e("For example, if you have WordPress 5.6 on this site and you copy this site's database to a host that has WordPress 5.8 files "
